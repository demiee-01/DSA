...
class Priority_q{
    ...
    public:
        void run_priority_q(){
            ...
            cout<<"Priority_queue size after pop : "<<pq.size()<<endl;
            cout << "Top (max) after pop: " << pq.top()<<endl; 
            cout<<"Priority_queue Biggest firts after pop : ";
            while(!pq.empty()) {
                cout << pq.top() << " ";
                pq.pop();
            }
    ...
    //===============================================================
            ...
            cout << "Top (min) after pop: " << p_q.top() << endl;
            cout<<"Priority_queue size after pop: "<<p_q.size()<<endl;
            cout<<"Priority_queue Smallest firts after pop: ";
            while(!p_q.empty()) {
                cout << p_q.top() << " ";
                p_q.pop();
            }
...
// Linked List, push_front, push_back, pop_front, 
//pop_back, size, max_size, empty, front, back, begin, end, rbegin, rend, cbegin 
class List{
    list<int> myList;
    public:
       void lis(){
